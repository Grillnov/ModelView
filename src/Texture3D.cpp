	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_UNSIGNED_BYTE, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_BYTE, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_UNSIGNED_SHORT, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_SHORT, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_UNSIGNED_INT, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_INT, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_FLOAT, Pixels);
	...
	GLint internalFormat, GLint clientsideFormat, GLsizei levels, bool generateMipMap)
{
	...
	glTexStorage3D(GL_TEXTURE_3D, levels, internalFormat, xWidth, yHeight, dDepth);
	glTexSubImage3D(GL_TEXTURE_3D, 0, 0, 0, 0, xWidth, yHeight, dDepth, clientsideFormat, GL_DOUBLE, Pixels);
