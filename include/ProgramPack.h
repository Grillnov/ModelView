...
*/
class ProgramPack : public GLAsset
{
private:
...
public:
	/**
	@brief Register a program in the OpenGL context.
	*/
	ProgramPack();

	/**
	@brief Unregister the program from the OpenGL context, recycling its name for further use.
	*/
	~ProgramPack();

	/**
	@brief Compile the shaders and link them into a program when ready.
	*/
	void Link();
	...
	*/
	...
	/**
	@brief Directly feed this program with uniforms by names.
	...
	*/
	...
	/**
	@brief Directly feed this program with shaders by types.
